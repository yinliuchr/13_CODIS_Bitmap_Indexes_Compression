#ifndef __INTER_BITMAP_CODIS_TEST__
#define __INTER_BITMAP_CODIS_TEST__
...
void testSetIntersection() {
	...
	CODISWAHSet sa, sb, sc;
	sa.fromVector(A);
	sb.fromVector(B);
	CODISWAHSet::setIntersection(sc, sa, sb);
...
void testRandom() {
	...
	CODISWAHSet::setIntersection(c, a, b);
	c.toVector(A);
